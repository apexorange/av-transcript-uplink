...
@anvil.server.callable()
def prepare_text_for_powerpoint(text, name_checkbox_state, obj_checkbox_state, witness_name_checkbox_state, witness_name_text):
    ...
    objection_phrases = ["MR", "MRS", "MS", "ATTY", "ATTORNEY"]  # phrases or words that affect capitalization and are flagged for removal
    non_party_phrases = [
